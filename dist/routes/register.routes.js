 ...
 */
router.post('/', _register.createRegister);
/**
 * @swagger
 * /producer/api/v1/Registers:
 *  get:
...
router.get('/', _register.getRegisters);
/**
 * @swagger
...
router.get('/all', _register.getRegisterswithDelete);
/**
 * @swagger
...
router.get('/:id', _register.getRegister);
/**
 * @swagger
...
router.get('/registerby/:id', _register.getRegisterbyUser);
/**
 * @swagger
 * /producer/api/v1/Registers/{id}:
 *   put:
...
router.put('/:id', _register.updateRegister);
/**
 * @swagger
 * /producer/api/v1/Registers/{id}:
 *   delete:
...
router.delete('/:id', _register.deleteRegister);
var _default = router;
