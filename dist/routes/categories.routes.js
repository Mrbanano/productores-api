 ...
 */
router.post('/', _categories.createCategory);
/**
 * @swagger
 * /producer/api/v1/Categories:
 *  get:
...
router.get('/all', _categories.getCategoriesAndDeletes);
/**
 * @swagger
...
router.put('/:id', _categories.updateCategory);
/**
 * @swagger
 * /producer/api/v1/Categories/{id}:
 *   delete:
...
router.delete('/:id', _categories.deleteCategory);
var _default = router;
